\documentclass[../DocumentoOficial.tex]{subfiles}
\title{\Huge DISEÑO}
\date{\today}
\author{Grupo PMC}
\pagestyle{plain}
...
\titleformat{\chapter}[block]{\normalfont\huge\bfseries}{\thechapter.}{0.5cm}{\Huge #1}[\titlerule]
    \titleformat{\section}{\normalfont\Large\bfseries}{}{0cm}{#1}
    \titleformat{\subsection}{\normalfont\large\bfseries}{}{0cm}{\uline{#1}}
    \titleformat{\subsubsection}{\normalfont\normalsize\bfseries}{}{0cm}{#1}
...
El patrón de diseño principal en el proyecto es el \textbf{Modelo-Vista-Controlado}r; ideal para un juego de las características de \texttt{Rolit}.
...
El UML detallado sería el siguiente:

\begin{center}
\includegraphics[scale=0.125]{mvcuml.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.75]{ranking-2players.png}

Ranking para dos jugadores
\end{center}

\begin{center}
\includegraphics[scale=0.75]{ranking-3players.png}
...
\begin{center}
\includegraphics[scale=0.41]{umlconexiones.png} 
\end{center}

\item Cómo se inicia una partida

\begin{center}
\includegraphics[scale=0.42]{empezarPartidaUml.png} 
\end{center}

\item Cómo se envía y recibe una jugada

\begin{center}
\includegraphics[scale=0.42]{juegoTipicoUml.png} 
\end{center}
...
\end{sprint}
    ...
    \titleformat{\section}{\normalfont\Large\bfseries}{\thesection}{0.25cm}{\uline{#1}}
    \titleformat{\subsection}{\normalfont\large\bfseries}{\thesubsection}{0.15cm}{#1}
    \titleformat{\subsubsection}{\normalfont\normalsize\bfseries}{}{0cm}{$\ast$ #1 $\ast$}
