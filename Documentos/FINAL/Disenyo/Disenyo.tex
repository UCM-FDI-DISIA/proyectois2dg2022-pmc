...
\begin{center}
\includegraphics[scale=0.40]{SaveCommand_execute_final.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.5]{GameClassicPlay_final_seq}
\end{center} 
...
\begin{center}
\includegraphics[scale=0.45]{GameTeams_final_seq}
\end{center}
