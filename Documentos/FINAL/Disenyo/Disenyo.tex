...
\item MinimaxStrategy: Estrategia basada en el algoritmo Minimax y la poda Alfa-Beta (estrategia de nivel alto, explicaciones detalladas en los anexos \hyperref[ch:AnexoII]{Anexo II} y \hyperref[ch:AnexoIII]{Anexo III}) 
\end{itemize}
...
Para entender el propósito y funcionamiento de esta clase, es importante leer antes los anexos \hyperref[ch:AnexoII]{Anexo II} y \hyperref[ch:AnexoIII]{Anexo III}.
...
\chapter{Anexo II: Estrategia Minimax adaptada a Rolit}
\label{ch:AnexoII}
...
\chapter{Anexo III: Poda Alfa-Beta}
\label{ch:AnexoIII}
