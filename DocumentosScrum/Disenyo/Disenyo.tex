...
\begin{center}
\includegraphics[scale=0.5]{celda-gui-sprint3}
\end{center}
...
La clase \textit{BoardGUI} extiende de JPanel y es la encargada de visualizar el tablero de la partida. Se puede apreciar que el tablero está formado por un conjunto de \textit{CeldaGUI}.


Esta ventana permitía elegir entre las principales opciones disponibles en el momento. Si se elige crear o cargar un juego, una vez configurado o cargado, el panel principal de la clase es reemplazado po 
